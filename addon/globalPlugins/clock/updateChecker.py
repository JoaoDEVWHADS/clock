...
try:
    CURRENT_VERSION = addonHandler.getCodeAddon().manifest.get('version', '2026.05.21')
except Exception:
    CURRENT_VERSION = "2026.05.21"
...
class UpdateNotificationDialog(wx.Dialog):
    def __init__(self, parent, current_version: str, new_version: str,
        ...
        super().__init__(
            parent,
            title=_("Update Available - Clock"),
    ...
    def _init_ui(self, current_version: str, new_version: str, release_info: dict):
        ...
        message = _(
            "A new version of Clock is available!\n\n"
    ...
    def _prompt_restart(self):
        ...
        result = gui.messageBox(
            _("Clock has been updated to version {version}.\n\n"
